...
const items = [
  {
    id: 'item-1',
    question: 'What is Betrix?',
    answer:
      'Betrix is a personal project created by Georgio Charro. It is not intended to promote gambling, but rather to showcase my coding skills and technical experience through a realistic online gaming platform.',
  },
  {
    id: 'item-2',
  ...
  },
  {
    ...
    answer:
      'Currently, there is no deposit option available. This is because operating real-money gaming platforms without a proper license is illegal in Lebanon. Betrix is a demo project meant to showcase technical capabilities only.',
  },
  {
    id: 'item-5',
