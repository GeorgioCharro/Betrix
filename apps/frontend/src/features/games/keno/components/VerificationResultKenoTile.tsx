...
function VerificationResultKenoTile({
  ...
  return (
    <div
      className={cn(
        'w-full aspect-square md:size-12 bg-brand-weaker rounded-lg cursor-pointer flex items-center justify-center font-semibold p-2 shadow-[0_0.3em_#213743] text-sm md:text-base',
        {
